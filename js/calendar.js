...
"\n" +
"Seleccion de Fecha:\n" +
"- Usa \xab, \xbb para seleccionar el anio.\n" +
"- Usa los botones " + String.fromCharCode(0x2039) + ", " + String.fromCharCode(0x203a) + " para el mes.\n" +
"- Manten presionado el boton para seleccion mas rapida.\n";
Calendar._TT["ABOUT_TIME"] = "\n\n" +
"Seleccion de la hora:\n" +
"- Haz click en el tiempo apra incrementarlo\n" +
"- o presionar Shift y click para decrementarlo\n";

Calendar._TT["PREV_YEAR"] = "Prev. Anio";
Calendar._TT["PREV_MONTH"] = "Prev. Mes";
Calendar._TT["GO_TODAY"] = "Ir al dia de Hoy";
Calendar._TT["NEXT_MONTH"] = "Sig. Mes";
Calendar._TT["NEXT_YEAR"] = "Sig. Anio";
...
Calendar._TT["CLOSE"] = "Cierra Calendario";
Calendar._TT["TODAY"] = "Hoy";
Calendar._TT["TIME_PART"] = "(Shift-)Click o Arrastra para cambiar este valor";
