...
$params = array();
$params["serverid"] = md5("Sala de Consultas"); // calculate a unique id for this chat
$params["title"] = "Sala de Consultas";
...
$params["height"] = "400px";
$params["channels"] = array("Fechas", "Examenes","Temas Varios");
//$params["theme"] = "blune";
...
$info  = new pfcInfo( md5("Sala de Consultas") );
