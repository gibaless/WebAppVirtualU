...
$params = array();
$params["serverid"] = md5("Sala de Noticias"); // calculate a unique id for this chat
$params["title"] = "Sala de Noticias";
...
$params["height"] = "400px";
$params["channels"] = array("Sala de Noticias");
//$params["theme"] = "blune";
...
$info  = new pfcInfo( md5("Sala de Noticias") );
