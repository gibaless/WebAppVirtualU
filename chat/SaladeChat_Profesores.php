...
$NombredeSala = "Sala de Profesores";
require_once dirname(__FILE__)."/src/pfcinfo.class.php";
require_once dirname(__FILE__)."/src/phpfreechat.class.php";
$params = array();
$params["serverid"] = md5($NombredeSala); // calculate a unique id for this chat
$params["title"] = $NombredeSala;
...
$params["height"] = "400px";
$params["channels"] = array($NombredeSala);
//$params["theme"] = "blune";
...
$info  = new pfcInfo( md5($NombredeSala) );
...
//Sala exclusiva para profes y estudiantes 
$RequireAccess = "A|P|Y";
include "../access.php";
include "../header2.php"; 
/* Variables del chat */
